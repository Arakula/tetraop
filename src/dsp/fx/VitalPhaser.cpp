...
void VitalPhaser::init(float srate, float freq, float q)
{
...
float VitalPhaser::eval(float sample)
{
...
void VitalPhaser::reset(float sample)
{
...
void VitalPhaser::tick()
{
    g.tick();
    k.tick();
}

void VitalPhaser::setLerp(int duration)
{
